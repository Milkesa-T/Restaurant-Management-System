...
class Order extends Model
{
    protected $fillable = [
        ...
        'submitted_at', 'approved_at', 'chef_started_at', 'chef_completed_at',
        'waiter_picked_at', 'served_at', 'bill_requested_at', 'paid_at', 'closed_at',
        'cancelled_at', 'rejected_at', 'duration_approval_seconds', 'duration_prep_seconds',
        'duration_pickup_seconds', 'duration_delivery_seconds', 'duration_total_service_seconds',
        'duration_total_lifecycle_seconds'
    ];
